export default function Projects() {
    return (
        <div id="projects" className="h-screen w-screen bg-white flex flex-col items-center justify-center">
            ...
            <section className="mb-8 mx-10" data-aos="fade-right" data-aos-delay="300">
            ...
            <section className="mb-8 mx-10" data-aos="fade-right" data-aos-delay="400">
            ...
            <section className="mb-8 mx-10" data-aos="fade-right" data-aos-delay="500">
            ...
            <section className="mx-10" data-aos="fade-right" data-aos-delay="600">
