    ...
    return (
        <>
            <div className="h-screen w-screen bg-white  flex-col md:flex-row hidden md:flex">
                ...
                <div className="bg-blue-900 w-4/5 min-w-64  h-2/5 rounded-lg mt-2 m-2" data-aos="fade-down-left"></div>
                <div className="bg-blue-900 w-4/5 h-2/5 rounded-lg mt-2 m-2" data-aos="fade-up-right"></div>
